                            ...
                            <div class="card adaptable-card !border-b pb-6 py-4 rounded-br-none rounded-bl-none">
                                <div class="card-body">
                                    <div class="form-item flex gap-2">
                                        <div class="w-1/2">
                                            <x-admin.input label="Nama Wilayah" id="nama_wilayah" name="wilayah.nama_wilayah"
                                    ...
                                    <div class="form-item flex gap-2">
                                        <div class="w-1/2">
                                            <x-admin.input label="Kode Wilayah" id="kode_wilayah" name="wilayah.kode_wilayah"
                                                :isDisabled="$isDisabled" />
                                        </div> <!-- input item end -->
                                    ...
                                    <div class="form-item flex gap-2">
                                        <div class="w-1/2">
                                            <x-admin.textarea label="Keterangan" id="keterangan" name="wilayah.keterangan"
