...
class Index extends Component
{
    ...
    public string $subtitle = "Data Pengumuman kerja di untuks setiap petugas lapangan";
    ...
    public function mount(): void
    {
        if ($this->menu === 'create') {
            ...
            $this->subtitle = "Tambah data Pengumuman kerja untuk setiap petugas lapangan";
        }
    ...
    {
        if ($this->menu === 'create') {
            $this->redirect(route('pengumuman'));
        }
        if ($this->menu === '') {
            $this->menu = 'create';
            $this->buttonTitle = 'Kembali';
    ...
    {
        if($this->menu === 'view'){
            $this->dispatch('load-pengumuman', id:$id, menu: 'edit');
        }
        $this->menu='edit';
        $this->id = $id;
        $this->buttonMenu();
    ...
    public function delete($id): void
    {
        try {
            ...
            $this->redirectRoute($this->title === 'pengumuman', ['menu' => 'tempat_sampah']);
        }catch (\Exception $e){
