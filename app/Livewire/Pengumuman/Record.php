...
class Record extends Component
{
    ...
    {
        $record = Pengumuman::query()->withTrashed()->find($id);
        $type = 'publik';
    ...
    {
        $record = Pengumuman::query()->withTrashed()->whereNotNull('deleted_at')->find($id);
        $record->deleted_at = null;
        $record->save();
    ...
    public function delete($id): void
    {
        ...
        $record = Pengumuman::query()->find($id);
        $record->published_at = null;
        $record->save();
        $record->delete();
    ...
    {
        $this->totalAll = Pengumuman::query()->count();
        $this->totalPublik = Pengumuman::query()->published()->count();
        $this->totalKonsep = Pengumuman::query()->draft()->count();
        $this->totalTempatSampah = Pengumuman::query()->withTrashed()->whereNotNull('deleted_at')->count();
        ...
        return view('livewire.pengumuman.record', ['records' => $records]);
