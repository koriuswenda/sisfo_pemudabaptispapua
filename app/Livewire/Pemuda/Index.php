...
class Index extends Component
{
    ...
    public string $subtitle = "Data Pemuda kerja di untuks setiap petugas lapangan";
    public string $title = "Pemuda";
    ...
    public function mount(): void
    {
        if ($this->menu === 'create') {
            ...
            $this->subtitle = "Tambah data Pemuda kerja untuk setiap petugas lapangan";
        }
    ...
    {
        if($this->menu === 'view'){
            $this->dispatch('load-pemuda', id:$id, menu: 'edit');
        }
        $this->menu='edit';
        $this->id = $id;
        $this->buttonMenu();
    ...
    public function delete($id): void
    {
        try {
            ...
            $this->redirectRoute($this->title === 'Pemuda', ['menu' => 'tempat_sampah']);
        }catch (\Exception $e){
    ...
    {
        return view('livewire.pemuda.index');
    }
