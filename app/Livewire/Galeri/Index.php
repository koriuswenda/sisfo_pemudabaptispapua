...
class Index extends Component
{
    ...
    public string $subtitle = "Data Galeri kerja di untuks setiap petugas lapangan";
    ...
    public function mount(): void
    {
        if ($this->menu === 'create') {
            ...
            $this->subtitle = "Tambah data Galeri kerja untuk setiap petugas lapangan";
        }
    ...
    {
        if($this->menu === 'view'){
            $this->dispatch('load-galeri', id:$id, menu: 'edit');
        }
        $this->menu='edit';
        $this->id = $id;
        $this->buttonMenu();
    ...
    public function delete($id): void
    {
        try {
            ...
            $this->redirectRoute($this->title === 'galeri', ['menu' => 'tempat_sampah']);
        }catch (\Exception $e){
